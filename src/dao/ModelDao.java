...
public class ModelDao {
    ...
    public Model getById(int id) {
        Model obj = null;
        String query = "SELECT * FROM public.car_model WHERE id = ?";
        ...
        ArrayList<Model> modelList = new ArrayList<>();
            try {
                ResultSet rs = this.con.createStatement().executeQuery("SELECT * FROM PUBLIC.CAR_MODEL ORDER BY ID ASC");
                while(rs.next()){
        ...
        public boolean save(Model model){
            String query = "INSERT INTO public.car_model " +
                    "("+
                    "model_brand_id," +
                    "model_name," +
                    "model_type," +
        ...
        public boolean update(Model model){
            String query = "UPDATE public.car_model SET " +
                    "model_brand_id = ? , " +
                    "model_name = ? , " +
                    "model_type = ? , " +
                    "model_year = ? , " +
        ...
        String query = "DELETE FROM public.car_model WHERE id = ?";
        try{
            PreparedStatement pr = con.prepareStatement(query);
